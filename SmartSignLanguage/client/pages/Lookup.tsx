      ...
      <div className="ssl-app-page px-4">
        <div className="ssl-page-shell py-7 space-y-6">
          <PremiumPageHeader
            ...
            description="Search the learning library and watch the matching sign video instantly whenever you need a clear reference."
            ...
            <Card className="p-5 space-y-4 border-slate-200 dark:border-slate-800">
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">
                  Type a word or part of a word. Typing "ch" shows all words
                  containing "ch".
                </p>
              </div>
                ...
                {results.length === 0 ? (
                  ...
                  results.map((card) => {
                    ...
                    return (
                      ...
                      >
                        <span
                          className={`font-semibold ${isSelected ? "text-[#0056d2] dark:text-blue-300" : "text-slate-800 dark:text-slate-100"}`}
                        >
                          {card.word}
                        </span>
                        <span
